...
{
    public partial class Room_12 : Form
    {
        public Room_12()
        {
            InitializeComponent();
        ...
        private void Room_12_KeyDown(object sender, KeyEventArgs e)
        {
            if (picSilver1.Visible == false && picSilver2.Visible == false && picEmerald.Visible == false)
            {               
            ...
            {
                this.Hide();
                Rooms.Room_11 room11 = new Rooms.Room_11();
                room11.Show();
            }
