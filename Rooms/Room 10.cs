...
{
    public partial class Room_10 : Form
    {
        public Room_10()
        {
            InitializeComponent();
        ...
        private void Room_10_KeyDown(object sender, KeyEventArgs e)
        {
            if (picSilver1.Visible == false && picSilver2.Visible == false)
            {
            ...
            {
                this.Hide();
                Rooms.Room_5 room5 = new Rooms.Room_5();
                room5.Show();
            }
            ...
            {
                this.Hide();
                Rooms.Room_7 room7 = new Rooms.Room_7();
                room7.Show();
            }
        ...
        //prevents image from passing through walls/enemy 
        {
            foreach (Control x in this.Controls)
            {
                if (x is PictureBox && (string)x.Tag == "walls" && x.Visible == true)
                {
                    ...
                    {
                        playerImage.Location = new Point(287, 590);
                    }
                }
            }
